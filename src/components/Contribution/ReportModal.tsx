...
import { ContributionReportCreationRequest } from "../../types/contributionReport";
import { createContributionReport } from "../../services/contributionService";
...
const ReportModal: React.FC<ReportModalProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      setLoading(true);
      const payload: ContributionReportCreationRequest = {
        contributionId,
        reason: reasonsToSend.join(", "),
      };

      const res = await createContributionReport(payload);
